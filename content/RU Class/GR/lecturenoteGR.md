...
a massive object can feel a gravitational interaction immediately buse on Newtonian theory. 

$\Rightarrow$ It contrasts SR. (nothing can travel faster than C!)

## Equivalence Principle (EP.)

1. Gravitational mass  
   $$  
   \bar{F}_{2} \alpha-\bar{\nabla} \phi \rightarrow \bar{F}_{2}=-m_{2} \bar{\nabla} \phi  
   $$
2. Inertial mais  
   $$  
   \bar{F} \propto \bar{a} \rightarrow \bar{F}_{i}=m_{i} \bar{a}  
   $$
...
Einstein generalised WEP: Dropped particle $\rightarrow$ gravitational laws on physics. (free fall)  
...
At a receiver, the frequency al light got smaller.  
$$  
\frac{\Delta \lambda}{\lambda}=\frac{\Delta v}{c}=\frac{a h}{c^{2}} \rightarrow \text { redshift }  
$$
...
## Some Visualisation of Math on curved space.  
   $\rightarrow$ Extrinsic Curvature
        ...
        - It is not useful!  
    $\rightarrow$ Intrinsic Curvature.
        - Describe or identify the curvature via quantity defined on the considering space
        - It not required higher dimension


| eg)                        | Flat          | Curved                   |
| -------------------------- | ------------- | ------------------------ |
| 1.shortest curved          | straight line | curved line              |
| 2.iterior angle of triagle | 180 $\degree$ | sphere:>180$\degree$     |
|                            |               | hyperbolic:<180$\degree$ |
| 3.area of circle           | $\pi r^2$     | sphere:<$\pi r^2$        |
|                            |               | hyperbolic:>$\pi r^2$    |
| 4.circumference of circle  | $2\pi r$      | sphere:<$2\pi r$         |
|                            |               | hyperbolic:>$2 \pi r$    |


- Parallel ol geodesic btw 2 points  
  $\ggg$ Geodesic is a shortest curve on spacetime.  
